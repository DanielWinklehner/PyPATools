...
class SettingsHandler(object):
    ...
    Preferred: $HOME/.local/lib/python<version>/site-packages/PyPATools (Linux)
               $APPDATA/PyPATools (Windows)  (usually $APPDATA=C:\Users\<username>\AppData\Roaming)
    ...
    def __init__(self):
        ...
        if self._unix:
            self._path1 = "{}/.local/PyPATools".format(os.environ["HOME"])
        else:
            self._path1 = os.path.join("{}".format(os.environ['APPDATA']), "PyPATools")
    ...
    def load_settings(self):
        ...
        Preferred: $HOME/.local/lib/python<version>/site-packages/PyPATools
